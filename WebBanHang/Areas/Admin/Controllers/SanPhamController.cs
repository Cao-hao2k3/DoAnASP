...
namespace WebBanHang.Areas.Admin.Controllers
{
    ...
    public class SanPhamController : Controller
    {
        ...
        public SanPhamController(FashionShopDbContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        {
            var fashionShopDbContext = _context.SanPham.Include(s => s.HangSanXuat).Include(s => s.LoaiSanPham);
        ...
        public async Task<IActionResult> Create([Bind("ID,HangSanXuatID,LoaiSanPhamID,TenSanPham,DonGia,SoLuong,KichCo,DuLieuHinhAnh,MoTa")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,HangSanXuatID,LoaiSanPhamID,TenSanPham,DonGia,SoLuong,KichCo,DuLieuHinhAnh,MoTa")] SanPham sanPham)
        {
            if (id != sanPham.ID)
            {
                return NotFound();
